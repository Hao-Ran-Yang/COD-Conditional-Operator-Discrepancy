...
parser.add_argument('--warmup_num', type=int, default=4000, help='before this threshold, marginal only; after, conditional only')
...
def inv_lr_scheduler(param_lr, optimizer, iter_num, gamma, power, init_lr=0.001, weight_decay=0.0005):
    ...
    for param_group in optimizer.param_groups:
        ...
        param_group['weight_decay'] = weight_decay #dSprites里这里有*2
        i += 1
    return optimizer
